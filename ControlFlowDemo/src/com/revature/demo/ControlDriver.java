...
public class ControlDriver {
	...
	public static void main(String[] args) {
		...
		int num = 100;
		if(num < 200) {
			System.out.println("The Variable is less than  200.It is " +num);
		}
		/*
		 * if - else statement
		 */
	 ...
	 */
		...
		if(age<18) {
			...
			System.out.println("you are a minor65 or older");
			}
	/*
	 ...
	 */
		num = 100;
		if(num < 101) {
			System.out.println("The variable is less than 101");
