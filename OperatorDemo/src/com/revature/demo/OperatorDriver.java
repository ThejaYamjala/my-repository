...
public class OperatorDriver {
	...
	public static void main(String[] args) {
		...
		//prefix increment, which will evaluate the result pf adding 1 first
		System.out.println(++x); //-99
		//postfix increment will evaluate the pre-existing value before adding1
		System.out.println(x++); //-99
		...
		result = getTrue() && getFalse(); //false && true--> false
		...
		System.out.println("myStr is a String:" + myStr instanceof Object);
		System.out.println("myArrayList is a String:" + myArrayList instanceof Object);
		System.out.println("myArrayList is a String:" + myArrayList instanceof String);
		System.out.println("myStr is a List:" + ( myArrayList instanceof List));
